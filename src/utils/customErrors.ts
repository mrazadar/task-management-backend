...
export class BadRequestError extends HttpError {
  ...
  constructor(message: string = 'Bad Request') {
    super(message, StatusCodes.BAD_REQUEST); // Calls HttpError constructor with message and 400 status
...
export class UnauthorizedError extends HttpError {
  ...
  constructor(message: string = 'Unauthorized') {
    super(message, StatusCodes.UNAUTHORIZED); // Calls HttpError constructor with message and 401 status
...
export class ForbiddenError extends HttpError {
  ...
  constructor(message: string = 'Forbidden') {
    super(message, StatusCodes.FORBIDDEN); // Calls HttpError constructor with message and 403 status
...
export class NotFoundError extends HttpError {
  ...
  constructor(message: string = 'Resource not found') {
    super(message, StatusCodes.NOT_FOUND); // Calls HttpError constructor with message and 404 status
...
export class ConflictError extends HttpError {
  ...
  constructor(message: string = 'Conflict') {
    super(message, StatusCodes.CONFLICT); // Calls HttpError constructor with message and 409 status
